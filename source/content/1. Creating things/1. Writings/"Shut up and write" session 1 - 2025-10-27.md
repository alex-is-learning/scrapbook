...
- As with the "hit publish" sessions that I did at Ship It Week ("[I know what 'my thing' is](https://alexislearning.substack.com/p/ship-it-week)" and "[Becoming angry](https://alexislearning.substack.com/p/wednesday-at-ship-it-week)", I don't have any kind of agenda right now, I have no ideas in my head, I'm just gonna let it flow for a bit (e.g. as described in my famous [[04. It flows, if you let it]] vignette)
- "Hit Publish" was a great container that we did ~daily at [[Ship It Week log|Ship It Week]], and it's great if you're getting started and what you're bottlenecked on is publishing a few things to grow your confidence, but once publishing stuff isn't a problem, it becomes limiting because it of course, you're writing something for an hour and then hitting publish, AKA it's a first draft. I want to work on things for multiple days, if not maybe weeks, make them really good
- E.g., [Lennox Johnson](https://substack.com/@honestsignals?) has only written 3 substack posts, but he's got to 500 subscribers with those 3 posts, because they're very good, very dense, have clearly been sweated over
- Similarly, it's clear that [Sasha Chapin](https://sashachapin.substack.com/) is publishing things that he has polished for a while, and also they're based on ideas that he has chewed on for a while. Deeper wisdom rather than surface-level insights innit
## "Good for you!" "feedback" vs useful criticism
...
- Everything else I've received has been "this is great, keep going!". Which is very lovely and valuable to receive as a beginner, but I've received enough of it now! 
...
- Supportive hard-ass vibes:
	...
	- [The tweet, by the MathAcademy guy](https://x.com/justinskycak/status/1966961834994659680)
...
- Why improve my writing? Why not just think "I'm pretty good"? Well actually, the thing is, I don't want to like, improve on a per-sentence level via idk, watching lectures or something. When youtube serves me videos by "writing teachers" I'm mostly like "bleh". 
## Not "get better at writing", but "be more ambitious re: my writing"
- I think that actually I don't want to be taught how to *improve* as much as I want to just aim for more depth, more ~beauty, more profundity. So it's not even a case of adding new techniques as much as it is just a case of setting the bar higher. "Ok, this bit of writing is good, but I don't just want to publish it and call it a day. 
...
- Really, it's, instead of feeling satisfied with golden ==trinkets==, "check it out, I made something, I know it's only a small thing but it's mine, and it's quite pretty", aiming for gold ==ingots==, aiming for real substance. Etc. Anyway, you get the point. 
...
- I've never wanted to write fiction, short stories, because... something like, I've been too preoccupied with figuring out my own story, like, "==why would I make shit up==, who cares about made up shit, I don't care about making up characters and scenes and plots for the sake of it", etc
	- (this makes me wonder if there a few =="types of guy" re: writing fiction== (I mean, of course there are) → there is probably one key archetype of "loves telling stories", and maybe another which is like "this is how I process what has happened in my life")
- I *am* currently writing a few things: I wonder if I can harness the genuine aliveness there, rather than "no, I will force myself to invent a new character, because, idk, that's what David Foster Wallace would do"
...
2. Write a scene from my life, exactly how it happened, but with the ==wisdom of adult Alex==. E.g. as a teenager, key memory of being in car with my dad, us not connecting, key belief clicks into place of "it's my fault, I'm boring". Re-writing that story (as I'm doing over at [[Mythopoesis - same life story, different conclusions]], but like, prettily, and in a way that can be shared, making it in a way even more real) would be really great IMO
#### Empathy/compassion
