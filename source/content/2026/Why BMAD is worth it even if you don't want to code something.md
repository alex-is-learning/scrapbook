...
- 👆 I have the following in my text expander app (Espanso), which I can paste immediately by typing `:handover`:
	...
	- And then I do /clear to clear the Claude Code context window. An essential [Claude Code best practice](https://code.claude.com/docs/en/best-practices)
...
[Introduction to the BMAD Method](https://www.youtube.com/watch?v=JuyIdqa0HJM)
