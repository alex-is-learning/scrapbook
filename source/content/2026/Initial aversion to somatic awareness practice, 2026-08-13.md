...
2. Zoom out, feel whole body at once, become familiar with general state of the body.
3. Do a quick tour through each sense gate in turn: sight, sound, smell, taste, mental image, mental sound, and emotion
4. Expand to open awareness of the whole experience space with all the senses, then spend 10 min or so noting each sense as they arrive
5. Continue in this vein, but drop the noting and instead when you notice a sense deliberately make the connection to where you somatically feel (notice how the other senses cause somatic sensations and where). Proceed for the rest of the meditation like this — make sure to make the connection with all the sense (including thoughts)
# My issues
## 1. A lot to remember! 
...
1. Try to notice it for more senses
2. Interface with the doubt
...
- I'm thinking of the "[vasocomputation](https://opentheory.net/2023/07/principles-of-vasocomputation-a-unification-of-buddhist-phenomenology-active-inference-and-physical-reflex-part-i/)" stuff here too
