...
![gif1-frontier-growth](gif1-frontier-growth.gif)
...
![mal1-maladaptive-b-fires](mal1-maladaptive-b-fires.gif)
...
![mal2-feedback-rejected](mal2-feedback-rejected.gif)
...
In this column, the author lists **concrete behaviors** they currently engage in (or fail to do) that work **against** the Column 1 goal. This is not for problem-solving or explaining _why_ the behaviors happen, but simply for providing **descriptive depth and honesty** about how one is currently undermining their own aspirations.
