...
- Practice types:
	...
	2. Strong determination sits (for equanimity training, aversion/craving training)
	3. Somatic connection (a kind of open awareness that I currently *like less than eyes open open awareness* (will explore this below))
	4. Charlie Awbery-style open awareness (idk if Roger cosigned this though?)
- Practice types that *aren't* part of this right now but maybe should be?
