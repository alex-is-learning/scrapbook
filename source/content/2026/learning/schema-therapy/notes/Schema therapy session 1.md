...
1. The need to feel safe and securely attached
	- Depicted with a drawing of a house
2. The need to have a separate identity, autonomy
	- Depicted with a drawing of a kid on a tree branch with the parent stood watching (denoting being trusted to climb a tree)
3. The need to be able to express their emotions and have them validated
...
5. The need for discipline and boundaries
