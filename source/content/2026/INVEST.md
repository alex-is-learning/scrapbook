...
**N — Negotiable** A task isn't a rigid specification — it's a starting point for a conversation. The details of _how_ something gets built should be open to discussion between the team and whoever requested it. Only the core intent (what needs to happen and why) is fixed.
...
**T — Testable** There must be clear, objective criteria for when a task is _done_. If you can't define what "finished" looks like, the task is too vague. "The page should be fast" isn't testable; "the page loads in under 2 seconds" is.

---

### Why it matters

INVEST gives you a quick sanity check when defining or reviewing your workload. A task that fails any of these criteria is worth refining _before_ work begins, rather than discovering the problem halfway through. It keeps your backlog clean and your team moving efficiently.