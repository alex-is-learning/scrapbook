...
1. **Definitions**: Clearly defining the two or more elements being compared using examples, explanations, or descriptions.
2. **Shared Qualities**: A discussion of what the elements have in common.
3. **Unique Qualities**: A discussion of the traits that distinguish them from one another.
4. **A Clear Purpose**: A specific reason for making the comparison in the first place.
...
Many authors in _A World of Ideas_ rely on this method to build their arguments:
...
- **Niccolò Machiavelli:** His entire work, _The Prince_, is described as ==a "recitation of the circumstances" required for political success==. He argues that a leader must be ready to change their behavior according to the "winds of Fortune" and that circumstances ultimately determine whether it is possible to remain virtuous or necessary to "enter into evil".
- **Karl Marx:** In _The Communist Manifesto_, ==he analyzes historical economic circumstances==, such as how the growing needs of new markets caused the feudal system of industry to be replaced by the manufacturing system.
