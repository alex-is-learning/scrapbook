...
- So anyway, by default we're used to distrusting the signal in our body that says "I don't want to do this!", and instead power through and force ourself to do a thing
