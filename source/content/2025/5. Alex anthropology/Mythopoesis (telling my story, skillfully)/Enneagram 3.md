...
- Now, in October of 2025, I was like "I should maybe pay for a more official-looking test just to be sure". What if I've changed, or what if I was mistyped, it might be really useful to realise e.g. "oh shit I'm a 4"
- So I paid $20 for an online test from [The Enneagram Institute](https://www.enneagraminstitute.com/get-started-with-enneagram-tests/) which ended up being functionally identical to the free one which I found back in the day, lol, oh well
- And it typed me as either a 9 (peacekeeper), 3 (achiever) or 1 (reformer). Reading through them, only the 3 felt deeply true and resonant → the other two felt like things I've made myself do, or things that are downstream of being a 3, rather than like "oh shit this actually really describes me"
- The first time I was typed as a 3 there was this deep feeling of relief when reading about it like "oh shit, this is so me, I'm not super weird, this is a Type of Guy that you can be??"
- 👇 copy-pasting from the test results PDF I got
## Overview
...
### This "in brief" bit is so *astoundingly* me, holy shit
...
- Threes are the "stars" of the personality types—people of tremendous drive, ambition, and belief in themselves. 
	-  *My extra-woo friend Catherine said that my "human design" type is also like this ("[[Manifesting Generator]]")*
- Excel
	- Threes want to excel, to be the best at whatever they do, and they are willing to put in the effort it takes to do so. 
	- Threes can be found at the gym, taking classes at night, putting in extra hours at work, learning how to coordinate their best colors when they dress—basically doing what it takes to shine. 
- Diplomatic
	- While Threes are energetic and ambitious, they are also diplomatic—they want to be liked and esteemed by others. They strive to be presentable and appropriate, not wanting to come across in ways that would be disapproved of. 
...
- Above all, goal oriented
	...
	- They are hard workers, diligent and effective—and they like helping others to be that way, too.
- Adaptable
...
- Overly adaptable
	- While their adaptability can be an enormous asset, it can also be overdone, leaving Threes unsure of who they are or what their own deepest values are.
		- *I've been thinking about this recently as the curse of high openness*
...
- Efficient to a fault
	- The problem is that Threes can be efficient to a fault—becoming accomplishment machines, brushing their real feelings and needs aside to "get the job done." 
...
- Intense pressure, draining
	...
	- Even if they are not working at a career and are primarily keeping a home, they will strive to have the most outstanding home in their neighborhood and to be "Super-Mom" or "Super-Dad."
- Difficult to stop/rest
	- Threes find it difficult to stop or rest when they are caught up in their drive for success.
	- They believe that to do so is to risk failure—and most Threes would rather die than fail and risk being humiliated.
...
- Presenting successful images
	...
	- They believe that they can "fake it until they make it," but if Threes do not slow down to deal with their emotional problems, sooner or later, a crash is inevitable.
## Their Hidden Side
...
- Unless you knew a Three very well, you would never suspect the degree of emotional vulnerability and insecurity that they conceal beneath their smooth, efficient surface. The fact is that despite Threes' apparent social ease, there is great loneliness and a belief that they must not need help or support.
...
- Thus, Threes convince themselves that they must always be outstanding, superb, and exceptional—the best at whatever they are focusing on. 
- To be any less than this is to fail, to be worthless. 
- This is like the child who gets straight A's but is then tormented by getting an A-minus or a B-plus, or the athlete who wins several gold medals but then feels like a failure for getting a silver or bronze. 
- This kind of self-rejection and self-deception causes Threes a great deal of suffering. 
	- *Dude, is this a big part of the reason for my mega-self deprecation? Holding myself to a very high standard (straight As) and being super super aware of how I've always fallen short (according to myself)?*
...
## At Their Best
- Healthy Threes are excellent communicators, motivators, and promoters, and they know how to present something in a way that's acceptable and attractive. 
...
- Even when they are not "coaching" others, they often inspire people to become like them in some way.
...
- They are also "adaptable" in the best sense of the word. If they see that they are doing something incorrectly or that their methods are not reaping positive results, they are willing to learn another way and to change. 
...
- At their best, they are also tender, touchingly genuine, and affectionate—they truly become "heroes" and "role models" who inspire others by their outstanding achievements, humility, and warmth.
...
- When this occurs, they tend to go on "autopilot," attempting to just get through things without being bothered, in the manner of average Nines. 
...
- They may keep a "positive frame of mind" all day at work, only to come home and download their dissatisfaction onto their spouse or partner. ("I think my boss is going to go nuts on me when he finds out we still haven't got this report nailed down.") 
- Feelings of self-doubt, dread, suspicion, and anger at others' incompetence can all surface in contrast to the Three's usual "can do" attitude.
...
- Level 3: 
	- Ambitious to improve themselves, to be "the best they can be"—often become outstanding, a human ideal, embodying widely admired cultural qualities. 
...
- Level 4: 
	...
	- Become careerists, social climbers, invested in exclusivity and being the "best.
- Level 5: 
	...
	- Pragmatic and efficient, but also premeditated, losing touch with their own feelings beneath a smooth facade. Problems with intimacy, credibility, and "phoniness" emerge.
- Level 6: 
...
- Level 9: 
	- Become vindictive, attempting to ruin others' happiness. 
...
- Develop charity and cooperation in your relationships. 
	...
	- Nothing spectacular is required—simply a few moments of quiet appreciation. 
