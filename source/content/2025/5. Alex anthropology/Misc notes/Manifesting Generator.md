...
1. **Prime the sacral:** turn decisions into **yes/no prompts** (“Do I want to run this workshop tonight?”). Listen for **uh-huh/uh-uh** in the body.
...
2. **Wait to respond:** scan for incoming stimuli—requests, pings, problems, a thing on the street—then act on the ones that light you up.
3. **Inform before you burst:** one line to stakeholders: _“I’m going to try X for 20 min; I’ll loop back.”_ It reduces resistance.
4. **Prototype > plan:** build a scrappy v0, test, iterate. Your speed is the feature.
5. **Satisfaction metric:** if you end the day satisfied > 60% of the time, you’re on track; persistent frustration = change inputs or timing.
6. **Energy hygiene:** move your body daily and **use up sacral energy**; MGs tend to sleep better after physical output.
7. **Calendar guardrails:** short blocks (25–50 min), context labels, and visible “parking lots” so you can jump without losing threads.
8. **Quit cleanly:** when the gut goes cold, inform, wrap, and reallocate. Don’t force it.
## **Common MG pitfalls (and fixes)**
- **Starting without response → anger/friction.**
    _Fix:_ collect 3+ clear “responses” (requests, signs, invites) before launching.
- **Over-promising, under-finishing.**
    _Fix:_ define “done for now” criteria for each project; ship in increments.
- **People feel blindsided.**
    _Fix:_ default to micro-informing: who’s impacted, what you’re doing, when you’ll update.
- **Decision fuzziness (Emotional authority).**
    _Fix:_ sleep on big choices; if it isn’t a yes at multiple points on the wave, it’s a no for now.
