...
Warning: ${file.data.filePath} isn't yet tracked by git, last modification date is not available for this file`
            ...
            const coercedCreated = coerceDate(fp, created);
            const coercedModified = coerceDate(fp, modified);
            const coercedPublished = coerceDate(fp, published);
            file.data.dates = {
              created: coercedCreated,
              modified: coercedModified,
              published: coercedPublished
            };
...
var RecentNotes_default = /* @__PURE__ */ __name((userOpts) => {
  const RecentNotes = /* @__PURE__ */ __name(({
    ...
    return /* @__PURE__ */ jsxs16("div", { class: classNames(displayClass, "recent-notes"), children: [
      /* @__PURE__ */ jsx29("h3", { children: opts.title ?? i18n(cfg.locale).components.recentNotes.title }),
      /* @__PURE__ */ jsx29("ul", { class: "recent-ul", children: pages.slice(0, opts.limit).map((page) => {
        ...
        return /* @__PURE__ */ jsx29("li", { class: "recent-li", children: /* @__PURE__ */ jsxs16("div", { class: "section", children: [
          ...
          page.dates && /* @__PURE__ */ jsx29("p", { class: "meta", children: /* @__PURE__ */ jsx29(Date2, { date: getDate(cfg, page), locale: cfg.locale }) }),
          opts.showTags && /* @__PURE__ */ jsx29("ul", { class: "tags", children: tags.map((tag) => /* @__PURE__ */ jsx29("li", { children: /* @__PURE__ */ jsx29(
            "a",
            {
              class: "internal tag-link",
              href: resolveRelative(fileData.slug, `tags/${tag}`),
      ...
      opts.linkToMore && remaining > 0 && /* @__PURE__ */ jsx29("p", { children: /* @__PURE__ */ jsx29("a", { href: resolveRelative(fileData.slug, opts.linkToMore), children: i18n(cfg.locale).components.recentNotes.seeRemainingMore({ remaining }) }) })
    ] });
  }, "RecentNotes");
...
var config = {
  configuration: {
    pageTitle: "\u{1F4DD} Alex's scrapbook",
    pageTitleSuffix: "",
    enableSPA: true,
    enablePopovers: true,
    analytics: {
